...
coauthornet, author2int = coauthorship_network(a2p_df, focus_author_ids = [299546], focus_constraint='ego', show_progress=False)

print(coauthornet.nnz)  # 70 edges
print(author2int)  # between 17 authors